    ...
    return (
        <>
            <div className=" bg-cover bg-center h-[260px]">
                    <div className="  max-w-[1300px] mx-auto  pt-[68px] ">
                                        ...
                                        <span className="inline-block ml-[16px] border-b-[10px] h-[51px] border-[#2B159C] sm:ml-0">{t("industries.entertainment.header")}</span>
                                         </h1>
                    </div>
            ...
            <div className=" bg-white">
                    <div className="max-w-[1300px] pt-[100px] pb-[50px] mx-auto relative">
                        <div className="ml-[10px]">
                            <h1 className="text-5xl text-[#1C2045] font-extrabold max-w-[1110px] leading-[60px]">
                                {
                                    i18n.language === "en" ? (
                                        width > 429 ? (
                                            ...
                                            <span className="">{t("industries.entertainment.headerdes")}</span>
                                            <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] ">{t("industries.entertainment.system")}</span>
                                           
                                            </h1>
                                        ): (
                                            <h1 className="text-5xl text-[#1C2045] font-extrabold leading-[60px] ">
                                            <span className="">{t("industries.entertainment.headerdes")}</span>
                                            <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] ">System</span><br />
                                            <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] ">Solution</span>
                                            </h1>
                                        )
                                        ...
                                        width > 640 ? (
                                            ...
                                            width > 520 ? (
                                                <h1 className="text-5xl text-[#1C2045] font-extrabold leading-[60px] ">
                                                <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] ">{t("industries.entertainment.system")}</span><br />
                                                <span className="">{t("industries.entertainment.headerdes")}</span>
                                                </h1>
                                            ) : (
                                                <h1 className="text-5xl text-[#1C2045] font-extrabold leading-[60px] ">
                                                <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] ">Giải pháp hệ</span><br />
                                                <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] ">thống </span>
                                                <span className="">{t("industries.entertainment.headerdes")}</span>
                                                </h1>
                                            )
                            ...
                            <p className="text-[#3A505F] leading-[25px] text-[18px] font-montserrat mt-[15px]">{t("industries.entertainment.here")}</p>
                            <p className="text-[#3A505F] leading-[25px] text-[18px] font-montserrat mt-[15px]">{t("industries.entertainment.entertainment")}</p>
                            <p className="text-[#3A505F] leading-[25px] text-[18px] font-montserrat mt-[15px]">{t("industries.entertainment.with")}</p>
                ...
                <div className="  max-w-[1300px] mx-auto py-[50px] flex flex-col items-center relative ">
                        {
                            i18n.language === "en" ? (
                                <h1 className="text-5xl text-center text-[#1C2045] font-extrabold leading-[60px] ">
                                    ...
                                    <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] mr-[16px]"> {t("industries.entertainment.simplicity")}   </span>
                                ...
                                width > 537 ? (
                                    ...
                                    <h1 className="text-5xl text-center text-[#1C2045] font-extrabold leading-[60px] ">
                                        {t("industries.entertainment.control")}   
                                      <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)] mr-[16px]">sự đơn giản </span>
                                      <br />
        ...
        <div className=" flex items-center justify-center">
            <div className="flex flex-col gap-[30px] py-[50px] lg:px-[35px]  px-[100px] items-center sm:items-stretch ">
                <h1 className="text-center text-[#eef3fa] font-extrabold  text-[38px] leading-[56px]" >{t("industries.entertainment.quickstartheader")}</h1>
                <p className="text-center text-[#eef3fa] font-normal  text-[16px] leading-[24px] max-w-[1110px]">{t("industries.entertainment.quickstartdes")}</p>
