...
export const Agriculture = () => {
    ...
    if (width > 350){
        content = i18n.language === "en" ? contentHeading(t("industries.agriculture.header"), undefined, "[#B9AAFD]", "white") : contentHeading("Nông Nghiệp", undefined, "[#B9AAFD]", "white")
    }else{
        content =  i18n.language === "en" ?  contentHeading(t("industries.agriculture.nong"), t("industries.agriculture.nghiep"), "[#B9AAFD]", "white") : contentHeading("Nông", "Nghiệp", "[#B9AAFD]", "white")
    }
                        ...
                        <div className="ml-[10px]">
                            ...
                            { i18n.language === "en" ? (
                                <h1 className="text-5xl text-[#1C2045] font-extrabold leading-[60px] ">
                                    <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)]">  {t("industries.agriculture.header")}</span>
                                ...
                                width < 350 ? (
                                    <h1 className="text-5xl text-[#1C2045] font-extrabold leading-[60px] ">
                                    {t("industries.agriculture.headerdes")}
                                    <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)]">  {t("industries.agriculture.nong1")}</span>
                                    <br />
                                    <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)]">  {t("industries.agriculture.nghiep")}</span>

                                    </h1>
                                ) : (
                                <h1 className="text-5xl text-[#1C2045] font-extrabold leading-[60px] ">
                                    {t("industries.agriculture.headerdes")}
                                    <span className="inline-block border-b-[10px] h-[51px] border-[var(--tree-poppy)]">  {t("industries.agriculture.header1")}</span>
                                </h1>
                                )
                             )} 
                            </h1>
