...
export const Agriculture = () => {
    ...
    if (width > 350){
        content = contentHeading(t("industries.agriculture.header"), undefined, "[#B9AAFD]", "white")
    }else{
        content = contentHeading(t("industries.agriculture.nong"), t("industries.agriculture.nghiep"), "[#B9AAFD]", "white")
    }
