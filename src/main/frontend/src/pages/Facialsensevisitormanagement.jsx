        ...
        <>
            <div className=" xl:h-auto pb-[100px]">
                ...
                <div className="relative mt-28 max-w-[616px] flex flex-col gap-5">
                    ...
                    <LeafButton title={t("products.facialsensevisitormanagement.solution.get")} />
                    <PoppyButton title={t("products.facialsensevisitormanagement.solution.request")} />
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div className="flex justify-between mb-3">
                            ...
                            {t("products.facialsensevisitormanagement.solution.janesmith")}
                            </h6>
                        ...
                        <p className="font-normal text-sm">{t("products.facialsensevisitormanagement.solution.titlecheckid")}</p>
                        </div>
            ...
            <div className=" px-4 py-[100px] flex flex-col relative mx-auto gap-[50px] ">
                ...
                {i18n.language === "en" ? (
                            <h1 className="text-center text-5xl text-[#1C2045] font-extrabold  max-w-[832px]">
                                    ...
                                    {t("products.facialsensevisitormanagement.benefits.benefitheader")}
                                </span>
                            </h1>
                ) : (
                            <h1 className="text-center text-5xl text-[#1C2045] font-extrabold  max-w-[832px]">
                                <span style={{ whiteSpace: "nowrap" }} className="border-b-[10px]  inline-block h-11 border-[var(--tree-poppy)]">
                                {t("products.facialsensevisitormanagement.benefits.benefitheader")}
                                </span>
                                {t("products.facialsensevisitormanagement.benefits.header")}
                            </h1>
                    ...
                    <div className="flex sm:flex-col">
                      <ul className=" flex flex-col gap-4 sm:w-auto ">
                        <li className="flex text-lg items-start">
                          ...
                          <span className="font-semibold">{t("products.facialsensevisitormanagement.benefits.titlesecurity")}</span>{t("products.facialsensevisitormanagement.benefits.security")}
                          </p>
                        </li>
                        <li className="flex text-lg items-start">
                          <Check className="m-[7px] min-w-[14px]" />
                          <p className="text-[#3A505F] font-Montserrat text-regular">
                          <span className="font-semibold">{t("products.facialsensevisitormanagement.benefits.titleappointment")}</span>{t("products.facialsensevisitormanagement.benefits.appointment")}
                          </p>
                        </li>
                        <li className="flex text-lg items-start">
                          <Check className="m-[7px] min-w-[14px]" />
                          <p className="text-[#3A505F] font-Montserrat text-regular">
                          <span className="font-semibold">{t("products.facialsensevisitormanagement.benefits.titleincrease")}</span>{t("products.facialsensevisitormanagement.benefits.increase")}
                          </p>
                        </li>
                    ...
                    <div className="flex sm:flex-col">
                      <ul className=" flex flex-col gap-4 sm:w-auto ">
                        <li className="flex text-lg items-start">
                          <Check className="m-[7px] min-w-[14px]" />
                          <p className="text-[#3A505F] font-Montserrat text-regular">
                          <span className="font-semibold">{t("products.facialsensevisitormanagement.benefits.titleconvenience")}</span>{t("products.facialsensevisitormanagement.benefits.convenience")}
                          </p>
                        </li>
                        <li className="flex text-lg items-start">
                          <Check className="m-[7px] min-w-[14px]" />
                          <p className="text-[#3A505F] font-Montserrat text-regular">
                          <span className="font-semibold">{t("products.facialsensevisitormanagement.benefits.titleautomatic")}</span>{t("products.facialsensevisitormanagement.benefits.automatic")}
                          </p>
                        </li>
                        <li className="flex text-lg items-start">
                          <Check className="m-[7px] min-w-[14px]" />
                          <p className="text-[#3A505F] font-Montserrat text-regular">
                          <span className="font-semibold">{t("products.facialsensevisitormanagement.benefits.titlecontactless")}</span>{t("products.facialsensevisitormanagement.benefits.contactless")}
                          </p>
                        </li>
                ...
                <div className="flex justify-between  items-start sm:flex-wrap  sm:w-auto">
                    <div className="sm:flex-col flex px-[35px] flex-col py-[20px] gap-[30px] relative md:px-[15px]">
                        <img src={ cloud} alt=""  className=" absolute bottom-0 right-0 w-[300px] h-[300px] "/>
                            ...
                            </div> ) : (   <div className="flex h-[290px] mds:h-[370px] mds740:h-[480px] 460sm:h-[400px]">
                                <div className="flex sm:flex-col ">
                                    <ul className=" flex flex-col gap-[15px] sm:w-auto ">
                                    <li className="flex text-lg items-start ">
                                        <Check className="m-[7px] min-w-4" />
           ...
           <QuickStart />
            ...
            <div className="bg-[#EEF3FA] px-4 pb-[50px] pt-[30px] flex flex-col items-center relative">
                ...
                <div className=" flex items-center justify-center flex-col gap-[15px]">
                        ...
                        <p className="text-[#3A505F] text-[18px] font-normal leading-[25px] max-w-[900px] text-center">{t("products.facialsensevisitormanagement.applications.description")}</p>
                 </div>
