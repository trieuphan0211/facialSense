...
export const MainLayout = () => {
  ...
  useEffect(() => {
    switch (location.pathname) {
      case "/":
        setBg("bg-home bg-right-top bg-no-repeat  xl:!bg-[center_top_0rem]");
        setLogoImg(logo);
      ...
      case "/pricing-visitor-management":
        ...
        break;
      case "/company":
        setBg("bg-company w bg-center-top bg-no-repeat max-w-full");
        setLogoImg(logoWhite);
        document.title =
          "CheckID FacialSense Company | FacialSense Visitor Management";
        break;
      default:
        setBg("bg-home bg-right-top bg-no-repeat xl:!bg-left-top");
        setLogoImg(logo);
        document.title = "CheckID FacialSense Service | Mobile-ID";
        break;
    }
