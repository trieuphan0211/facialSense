...
import { PriceVitor } from "../../components/prices";
...
export const VisitorManagement = () => {
    ...
    return <>
            ...
            <div className="bg-white">
                <div className=" max-w-[1300px] pl-[10px] pt-[50px] pb-[24px] mx-auto px-4">
                    <div className="flex flex-col gap-[30px]">
                    {
                        i18n.language === "en" ? (
                            width > 1100 ? (
                                ...
                                CheckID FacialSense 
                                <span className="inline-block max740to460:ml-0  ml-4 mds:ml-0 border-b-[10px] h-[51px] border-[#F7941D]">  Visitor Management</span>
                                </h1>
                            ) : (
                                width > 540 ? (
                                    <h1 className={` h-[51px] text-5xl text-[#1C2045] font-extrabold leading-[60px] `}>
                                    CheckID FacialSense <br/>
                                    <span className={`inline-block ml-0 border-b-[10px] h-[51px] border-[#F7941D]`}> Visitor Management</span>
                                    </h1>
                                ) : (
                                    <h1 className={` h-[51px] text-5xl text-[#1C2045] font-extrabold leading-[60px] `}>
                                    CheckID FacialSense <br/>
                                    <span className="inline-block  ml-0 border-b-[10px] h-[51px] border-[#F7941D]"> Visitor</span><br />
                                    <span className="inline-block  ml-0 border-b-[10px] h-[51px] border-[#F7941D]"> Management</span>
                                    </h1>
                                )
                           ...
                           width > 1100 ? (
                            <h1 className={` h-[51px] text-5xl text-[#1C2045] font-extrabold leading-[60px] `}>
                            <span className="">CheckID FacialSense </span>
                            <span className={`inline-block  border-b-[10px] h-[51px] border-[#F7941D]`}> quản lý khách hàng</span>
                            ...
                            width > 540 ? (
                                <h1 className={` h-[51px]  text-5xl text-[#1C2045] font-extrabold leading-[60px] `}>
                                CheckID FacialSense <br/>
                                <span className={`inline-block ml-0 border-b-[10px] h-[51px] border-[#F7941D]`}>quản lý khách hàng</span>
    
                                </h1>
                            ) : (
                                <h1 className={` h-[51px] text-5xl text-[#1C2045] font-extrabold leading-[60px] `}>
                                CheckID FacialSense <br/>
                                <span className={`inline-block ml-0 border-b-[10px] h-[51px] border-[#F7941D]`}>quản lý</span><br/>
                                <span className={`inline-block ml-0  border-b-[10px] h-[51px] border-[#F7941D]`}>khách hàng </span>
                                </h1>
                            )
                        ...
                        <div className={`max429:mt-[180px]  ${width > 1100 ? "" : (width > 540 ? "mt-[80px]" : "mt-[190px]")} sm:mt-[180px] mds740:mt-[80px] 460sm:mt-[120px] mds:mt-[80px] gap-[30px] flex items-center justify-center`}>
                            <p 
                    ...
                    <div className={`${activeIndex === 0 ? "block" : "hidden"} `}>
                        <div className={`md:flex-col mlgd1160:flex-col flex items-center  pt-[50px] mlgd1160:gap-[30px]`}>
                            <div className="flex-1 md:flex-col md:gap-[30px] flex items-center justify-between gap-[10px]  ">
                            <PriceVitor
                                price={t("pricing.appoint")}
                                free={t("pricing.free")}
                                money={t("pricing.freemon")}
                                user={"5"}
                                month={" "}
                            />
                            <PriceVitor 
                                price={t("pricing.appoint1")}
                            ...
                            <div className="mlgd1160:ml-0 md:gap-[30px] ml-[1%] flex-1 md:flex-col flex items-center justify-between gap-[10px] md:">
                            <div className=" flex flex-col  mb-[60px] w-[300px] items-center md:mt-[30px] md:h-[400px]">
                                ...
                                <div className="flex bg-white h-[420px]  flex-col items-center  w-[290px]  py-[110px] px-[10px] rounded-[20px] shadow-shawdowprice border-solid  border-2 border-[#9B86FC] ">

                                    <p className="text-[#2B1C50] text-center text-[18px] font-normal">{t("pricing.appoint2")}</p>
                                    ...
                                    <div className="flex items-center pt-[30px]">
                                        ...
                                        <p className="text-[#2B1C50] text-center text-[18px] font-normal"><strong>50</strong> {t("pricing.dayaponit")}</p>
                                    </div>
                    ...
                    <div className={`${activeIndex === 1 ? "block" : "hidden"}`}>
                        ...
                        <div className="flex   justify-center items-center pt-[50px]">
                            ...
                            <div className="flex sm:flex-col  items-center gap-[35px]">
                            
                                    <div className="flex bg-white  h-[646px] flex-col items-center    py-[50px] px-[20px] rounded-[20px] shadow-shawdowprice border-solid  border-2 border-[#9B86FC] ">
                                        <div>
                                        <p className="text-[#2B1C50] text-center text-[18px] font-normal">{t("pricing.licensefor")}</p>
                                        <p className="text-[#2B1C50] text-center text-[30px] font-extrabold ">{t("pricing.server")}</p>
                                        </div>
                                       
                                        <div className="flex flex-col gap-0 items-center pt-[30px]">
                                            <div className="flex gap-[20px] items-center">
                                            <p className="text-[#002B4E] text-center text-[30px] font-extrabold">$</p>
                                            <p className="text-[#7F56D9] text-center text-[64px] font-extrabold leading-[50px] ">3,990</p>
                                            </div>
                                    ...
                                    <div className="flex bg-white  h-[646px]  flex-col items-center    py-[50px] px-[20px] rounded-[20px] shadow-shawdowprice border-solid  border-2 border-[#9B86FC] ">
                                            ...
                                            <p className="text-[#2B1C50] h-[72px] text-center text-[30px] font-extrabold ">{t("pricing.license")}</p>
                                            <div className="flex flex-col gap-0 items-center pt-[30px]">
                                                <div className="flex gap-[20px] items-center">
                                                <p className="text-[#002B4E] text-center text-[30px] font-extrabold">$</p>
