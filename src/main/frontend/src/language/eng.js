export default {
  ...
  industries: {
    ...
    organizations: {
      ...
      consumer: "A consumer fills out a lead form",
      consumerdes: "The first step for a lead is an interested consumer requesting information about a service on a premium website.",
      fresh: "Fresh Leads matches the lead to a buyer",
      freshdes: "Buyers in our system set which type and criteria of leads they want to receive. In real time our system finds a matching buyer for the lead, based on the options they selected.",
      buyer: "Buyers call their leads",
      buyerdes: "Leads are viewable in our CRM, or can be synced to one of 700 CRM systems",
      leads: "Leads are dispositioned",
      leadsdes: "Leads are dispositioned based upon whether they turned into a sale, weren’t interested, or quoted for the service.",
      ...
      safedes: "Touchless barcode, RFID, facial, and iris recognition technology that provides no-contact visitor identification."
    }
