...
export const Prices = ( {price, free, money, user} ) => {
    const { t  }  = useTranslation();
return (
    <div className="flex-1 flex flex-col w-[260px] items-center">
    <div className="flex flex-col items-center  w-[260px]   py-[60px] px-[20px] rounded-[20px] border-solid  border-2 border-[#EFF0FF] bg-[#EFF0FF]">
        ...
        <div className="flex flex-col items-center pt-[30px]">
            ...
            <p className="text-[#151686] text-center text-[30px] font-extrabold leading-[60px] ">{money}</p>
            </div>
            <p className="text-[#AEAEAE] text-center text-[22px] font-bold ">{t("pricing.month")}</p>
        ...
        <div className="flex items-center pt-[30px]">
            ...
            <p className="text-[#2B1C50] text-center text-[18px] font-normal"><strong>{user}</strong> {t("pricing.users")}</p>
        </div>
